...
test("allows pinned okkmax/codex-skins jsdelivr path", () => {
  assert.doesNotThrow(() => assertAllowedUrl("https://cdn.jsdelivr.net/gh/okkmax/codex-skins@a1b2c3d/skins/x/bg.jpg"));
});
...
test("rejects @main (must be pinned ref, not a branch)", () => {
  assert.throws(() => assertAllowedUrl("https://cdn.jsdelivr.net/gh/okkmax/codex-skins@main/skins/x/bg.jpg"));
});
test("rejects other hosts and http", () => {
  assert.throws(() => assertAllowedUrl("https://evil.com/x.jpg"));
  assert.throws(() => assertAllowedUrl("http://cdn.jsdelivr.net/gh/okkmax/codex-skins@abc/x.jpg"));
});
