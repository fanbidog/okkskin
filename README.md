...
npx okkskin@0.1.0 enable <钉死的 manifest URL | 本地主题目录>
npx okkskin@0.1.0 disable       # 停用常驻 + 还原

# 单次:只对当前这次会话生效,退出即失
npx okkskin@0.1.0 apply <钉死的 manifest URL | 本地主题目录>

# 其它
npx okkskin@0.1.0 status | restore | doctor
```

`<manifest URL>` 是从[皮肤库](https://www.okkmax.com)复制的完整钉死链接:

```
https://cdn.jsdelivr.net/gh/fanbidog/codex-skins@<commit>/skins/<id>/manifest.json
```
