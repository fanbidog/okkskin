...
Codex(ChatGPT 桌面端的 Codex)本身没有换肤入口。okkskin 让你从[皮肤库](https://www.okkmax.com/tools/skins)挑一款,复制一条命令在终端跑一下,Codex 的**整套界面配色 + 壁纸**就换好了 —— 而且**不动 Codex 安装包、不改代码签名**,随时能一键还原。
...
|            山湖公路 · 自然             |            战斗机甲 · 科幻             |
| :-----------------------------------: | :-----------------------------------: |
| ![山湖公路](assets/preview/road.jpg)  | ![战斗机甲](assets/preview/mecha.jpg) |

|            月下侠客 · 动漫             |            心之怪盗 · 游戏             |
| :-----------------------------------: | :-----------------------------------: |
| ![月下侠客](assets/preview/samurai.jpg) | ![心之怪盗](assets/preview/phantom.jpg) |

|           傲娇少女 · 浅色            |             祖国人 · 梗图             |
| :---------------------------------: | :----------------------------------: |
| ![傲娇少女](assets/preview/tsundere.jpg) | ![祖国人](assets/preview/homelander.jpg) |

|                启动页(换肤后的开屏)                 |
| :--------------------------------------------------: |
|          ![启动页](assets/preview/loading.jpg)          |

> 均为换肤后的真实 Codex 界面;皮肤库已有 25+ 款。主题挑选见[皮肤库](https://www.okkmax.com/tools/skins)。
...
挑一条粘进终端就能看效果。想只试当前这次会话,把 `enable` 换成 `apply`(退出 Codex 即失效)。**看完用最后一条一键还原。**

```bash
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/road/manifest.json       # 山湖公路 · 自然
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/samurai/manifest.json    # 月下侠客 · 动漫
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/tsundere/manifest.json   # 傲娇少女 · 浅色
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/mecha/manifest.json      # 战斗机甲 · 科幻
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/phantom/manifest.json    # 心之怪盗 · 游戏
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/judy/manifest.json       # 疯狂动物城 · 动漫
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/cafe-girl/manifest.json  # 咖啡少女 · 魅力
npx okkskin@0.2.0 enable https://www.okkmax.com/skins/keion/manifest.json      # 惊讶少女 · 浅色

# ↓ 一键还原:停用换肤,Codex 回原版
npx okkskin@0.2.0 disable
```

更多主题在[皮肤库](https://www.okkmax.com/tools/skins)挑,每张卡片都能一键复制命令。
