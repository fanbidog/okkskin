...
npx okkskin@0.1.1 enable <钉死的 manifest URL | 本地主题目录>
npx okkskin@0.1.1 disable       # 停用常驻 + 还原

# 单次:只对当前这次会话生效,退出即失
npx okkskin@0.1.1 apply <钉死的 manifest URL | 本地主题目录>

# 其它
npx okkskin@0.1.1 status | restore | doctor
```
